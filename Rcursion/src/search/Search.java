...
public class Search {
	 ...
	 * Specification
	 * 
	 * -It sequentially checks each element of the array -Return index if a match is
	 * found -Return -1 if element is not found in array
	 * 
	 * @param array
	 * @param element
	 * @return i|-1
	...
	/**
	 * Specification
	 * -It search element by repeatedly dividing the search interval into half. 
